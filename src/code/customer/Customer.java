...
public class Customer extends Person {
    ...
    public Customer(String username, String password, String name, String lastName, String gender, int age, MemberClass memberClass) {
        super(username, password, name, lastName, gender, age);
        numCustomers++;
        this.memberClass = memberClass;
        basketList = new ArrayList<>();
        historyList = new ArrayList<>();
        customerUsername = "Member" + numCustomers;
        customerPassword = password;
    }
    
    public Customer(String username, String password, String name, String lastName, String gender, String age, String memberClass) {
        super(username, password, name, lastName, gender, Integer.parseInt(age));
        numCustomers++;
    ...
    public Object[][] getBasketToArray() {
        ...
        // first [] is row of all orderElement, second [] is get info of product and add by 1 (Because number in OrderElement)
    ...
    public Object[] getCustomerInfo(int element) {
        Object[] all = new Object[]{
                getUsername() ,getCustomerPassword(), getName(), getLastName(), getGender(), getAge(), getMemberClass().getName()};
    ...
    public Object[][] getHistoryListInform(int index) {
        Object[][] temp = new Object[historyList.get(index).getBuyList().size() + 1][6];
        ...
        for (int j = 0; j < temp.length - 1; j++) {
            ...
            temp[j][4] = historyList.get(index).getBuyList().get(j).getNum(); // number of product
            temp[j][5] = historyList.get(index).getBuyList().get(j).getPriceToString(); // price
        }
    ...
    public Customer clone() {
        numCustomers--;
        Customer temp = new Customer(getUsername() ,getCustomerPassword(), getName(), getLastName(), getGender(), getAge(), getMemberClass());
